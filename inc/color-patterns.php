 ...
 */
function pleiadesrealm_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'pleiadesrealm_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.pleiadesrealm-front-page) .entry-title,
...
.colors-custom .pleiadesrealm-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.pleiadesrealm-front-page .panel-content .recent-posts article,
...
.colors-custom.pleiadesrealm-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'pleiadesrealm_custom_colors_css', $css, $hue, $saturation );
}
